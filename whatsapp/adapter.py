...
class WhatsAppPipeline:
    ...
    def __init__(
        ...
        self._iterator: Optional[ChatIterator] = None
        self._scanner: Optional[MessageScanner] = None
        self._downloader: Optional[DocumentDownloader] = None
        
        # Callbacks
        self.on_chat_processed: Optional[Callable[[str, int], None]] = None
        self.on_document_found: Optional[Callable[[MessageInfo], None]] = None
        self.on_document_downloaded: Optional[Callable[[str], None]] = None
